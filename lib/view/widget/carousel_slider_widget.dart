...
class Discover extends StatefulWidget {
  Discover({super.key, this.themeData, this.genres, this.api});
  final ThemeData? themeData;
  final List<Genres>? genres;
  final String? api;

  @override
  State<Discover> createState() => _CarouselSliderImageState();
}

class _CarouselSliderImageState extends State<Discover> {
  ...
  void initState() {
    super.initState();
    controller.fetchMovies(Endpoints.discoverMoviesUrl(1)).then((value) {
      setState(() {

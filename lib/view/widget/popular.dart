...
class Popular extends StatefulWidget {
  Popular({super.key, this.themeData, this.genres, this.api});
  final ThemeData? themeData;
  final List<Genres>? genres;
  final String? api;

  @override
  State<Popular> createState() => _CarouselSliderImageState();
}

class _CarouselSliderImageState extends State<Popular> {
  ...
  void initState() {
    super.initState();
    controller.fetchMovies(Endpoints.popularMoviesUrl(5)).then((value) {
      setState(() {

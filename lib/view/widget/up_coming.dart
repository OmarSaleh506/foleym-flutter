...
class UpComing extends StatefulWidget {
  UpComing({super.key, this.themeData, this.genres, this.api});
  final ThemeData? themeData;
  final List<Genres>? genres;
  final String? api;

  @override
  State<UpComing> createState() => _CarouselSliderImageState();
}

class _CarouselSliderImageState extends State<UpComing> {
  ...
  void initState() {
    super.initState();
    controller.fetchMovies(Endpoints.upcomingMoviesUrl(1)).then((value) {
      setState(() {
